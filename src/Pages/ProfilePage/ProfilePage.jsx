  ...
  return (
    <div className="bg-gradient-to-r from-[#0f0850] via-[#103b74] to-[#4d50c2] opacity-95 ">
      ...
      <div className=" py-10 px-4 lg-px-0">
        <div className="bg-[#DBE3EA] max-w-7xl m-auto  py-9 px-10 rounded-3xl  flex items-center  gap-6">
          <div className="relative w-[140px] h-[124px] mx-auto ">
            ...
            <img
              ...
              src={image ? URL.createObjectURL(image) : "default-image-url.jpg"} // Placeholder for image
              alt=""
