      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
        ...
        <div className="bg-[#ffffff15] px-16 border-2 border-gray-500  backdrop-blur-sm text-white py-8  text-center  rounded-3xl">
          ...
          <p className="text-gray-300">
            Our team comprises industry-certified professionals with years of
            experience, ensuring top-quality service and expertise you can rely
            on.
          </p>
        </div>
        ...
        <div className="bg-[#ffffff15] px-16 border-2 border-gray-500  backdrop-blur-sm text-white py-8  text-center  rounded-3xl">
          ...
          <p className="text-gray-300">
            ...
            dedicated team ensure prompt, efficient service to minimize downtime
